# Parte 1: Investigue, cómo generar un programa que contenga dos archivos: Principal, en el cual, debe contener un menú con las opciones para acceder a cada función requerida. Sólo Considere el ingreso de datos y el despliegue de información. Funciones: Debe contener todos los procesos y validaciones de los requerimientos

# Parte 2: Un número de parte es un identificador único para cada parte de un producto que los fabricantes utilizan cuando lo diseñan (MPN - Manufacturing Part Number). Su objetivo es simplificar la referencia a esa parte. Un número de referencia identifica inequívocamente un diseño de la pieza dentro de una sola empresa, y en ocasiones la mayoría de las empresas. 
